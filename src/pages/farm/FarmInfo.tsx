...
const FarmInfo = () => {
  ...
  const farmCardProps = {
    ...
    onClick: ()=> {{console.log('Watch Detail')}},
    ...
    <Col>
        ...
        <div className='content-page'>
            <Col>
                ...
                <div style={{minWidth: '100%', minHeight: '120px', backgroundColor:'grey', marginBottom: "32px", marginTop: "16px"}}></div>
                <div style={{padding: '24px 36px'}}>
                    ...
                    <div style={{paddingBottom: "24px"}}>
                        <Row style={{display: 'flex', alignItems: 'center', justifyContent: 'flex-start'}}>
                            <div style={{fontSize: '20px', fontWeight: '500', marginRight: '12px', alignContent: 'center'}}> Farm Status: </div>
                            {FarmStateBadge(dataFarmInfo.statusFarm)}
                        </Row>
                    </div>
                    <div className='info-row'>
                        <Row >
                            <Row style={{display: 'flex', alignItems: 'center', width: '50%'}}>
                                <p className='row-label-item'>Farm Code:</p>
                                <p className='row-title-item'> {dataFarmInfo.farmCode} </p>
                            </Row>
                            <Row style={{display: 'flex', alignItems: 'center'}}>
                                <p className='row-label-item'>Farm Owner:</p>
                                <p className='row-title-item'> {dataFarmInfo.farmOwner?.email} </p>
                            </Row>
                        </Row>
                    </div>
                    <div className='info-row'>
                        <Row >
                            <Row style={{display: 'flex', alignItems: 'center', width: '50%'}}>
                                ...
                                <p className='row-title-item'> {dataFarmInfo.farmAddress ?? '-'} </p>
                            </Row>
                            <Row style={{display: 'flex', alignItems: 'center'}}>
                                <p className='row-label-item'>Farm Phone Number:</p>
                                <p className='row-title-item'> {dataFarmInfo.farmPhoneNumber ?? '-'} </p>
                            </Row>
                        </Row>
                    </div>
                </div>
